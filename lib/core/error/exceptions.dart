...
import '../resources/auth_response_messages.dart';
  ...
  static String handleError(DioException dioError) {
    ...
    switch (dioError.type) {
      ...
      case DioExceptionType.badResponse:
        // {"code":2,"loginDate":null,"token":null,"apkUrl":null}
        int errorCode = dioError.response?.data['code'];
        errorMessage = handleStatusCode(errorCode);
        break;
